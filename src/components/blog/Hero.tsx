  ...
  return (
    <div className="bg-black relative">
      ...
      <div className="max-w-[1172px] mx-auto px-4 pt-[70px] max-md:pt-16 max-sm:pt-12 pb-[30px]">
        ...
        <Description
          myClass="max-w-[674px] mx-auto text-center"
          text="Explore our latest articles, insights, and expert advice on industry trends. Stay informed, gain new perspectives, and discover valuable tips to help you stay ahead."
        />
      </div>
