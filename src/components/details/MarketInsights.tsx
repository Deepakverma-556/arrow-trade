    ...
    <div className="relative">
      <div className="max-w-[1172px] mx-auto px-4">
        <div className="flex md:justify-between max-md:flex-wrap-reverse">
          ...
          <div className="bg-[url(/assets/images/png/blur-bg.png)] bg-cover bg-no-repeat rounded-3xl max-h-max py-[30px] w-[364px] border-2 border-lightSky md:sticky top-4 right-0 z-10 max-md:w-full max-md:py-0">
